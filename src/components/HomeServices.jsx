       ...
       <div className='md:p-8 p-4 w-full h-full bg-white border border-gray-100 py-16 md:py-26 px-6 md:px-16 lg:px-20'>
                    <div className='flex flex-col lg:flex-row justify-between gap-6 w-full'>
                        <div className='lg:w-1/2 w-full'>
                            ...
                            <Link to='/shop'><motion.button initial={{opacity:0, y:20}} whileInView={{opacity:1, y:0}} transition={{duration:0.5, delay:0.5}} viewport={{once: true}} className='bg-[#5A1B08] mt-6 rounded-full text-white flex gap-2 items-center justify-center py-3 px-10 cursor-pointer'>
