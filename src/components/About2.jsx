...
import {Eye, Leaf ,Zap, ShieldCheck, ArrowRight} from 'lucide-react'
       ...
       <div className='flex flex-col items-center justify-center'>
        ...
        <p className='text-[#696462] text-center text-lg tracking-tight mt-2 max-w-2xl'>The Principles behind every Kindred Spirits creation</p>
         <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mx-auto mt-12'>
              {data.map((item, index)=>(
          <div key={index} className='border transition-all duration-500 ease-in-out hover:-translate-y-1 hover:scale-102 hover:shadow-2xl bg-[#f8f4f3] border-[#e9ddda] rounded-2xl p-6 flex flex-col gap-4'> 
